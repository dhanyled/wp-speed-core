...
class DatabaseHousekeeperTest extends TestCase {
    ...
    public function test_trim_revisions_prepares_sql_and_returns_affected_rows(): void {
        WP_Mock::expectActionAdded('wpsc_maintenance', [ new AnyInstance(DatabaseHousekeeper::class), 'maintain' ]);
    ...
    public function test_trim_revisions_returns_zero_when_no_revisions_deleted(): void {
        WP_Mock::expectActionAdded('wpsc_maintenance', [ new AnyInstance(DatabaseHousekeeper::class), 'maintain' ]);
